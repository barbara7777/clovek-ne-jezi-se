...
class UI: #user interface
    ...
    def __init__(self, parent):
        ...
        #self.font = ("Bradley Hand ITC", 20, "bold")
        self.font = ("Arial", 20)

        self.prikaz_casa = tk.Label(self.desni_del, text='Čas igre\n0', font=self.font)
        self.prikaz_casa.grid(row=0, column=0)

        self.restart_tipka = tk.Button(self.desni_del, bg='grey', text='Resetiraj', command=self.parent.restart, font=self.font, fg='white' )
...
class IGRA: #mehanika igre (vsebije UI)
    ...
    def prestavi(self, polje):
        ...
        #nastavimo gumbe na njihove položaje
        self.GUI.nastavi_gumbe(self.stevilke)
